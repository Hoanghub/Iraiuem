...
local Tabs = {
    ...
    Teleport = Window:AddTab({ Title = "Tab Island", Icon = "palmtree" }),
    ...
    Shop = Window:AddTab({ Title = "TabShop", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Tab Misc", Icon = "list-plus" }),
    Hop = Window:AddTab({ Title = "Tab Hop", Icon = "list-plus" }),
...
ImageButton.Image = "rbxassetid://16173156545"
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    _G.FastAttackXaoMi_Mode = Value
	if _G.FastAttackXaoMi_Mode == "Fast Attack" then
		_G.Fast_Delay = 0.04
	elseif _G.FastAttackXaoMi_Mode == "Normal Attack" then
		_G.Fast_Delay = 0.10
	elseif _G.FastAttackXaoMi_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0.01
	end
end)
    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "rbxassetid://16173156545" then
                    return v
                end
            end
        end
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://16173156545"
				huhu.ImageRectSize = Vector2.new(80, 80)
